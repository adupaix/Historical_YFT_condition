...
#'     Outputs are saved in that folder
...
#' 2023-02-17: Used again to generate the Figure 2 of the manuscript submitted to MEPS 
#' @for_study: canadian = T ; figure_dir = "2023-02-17-build_figures"
canadian = T
figure_dir = "2023-02-17-build_figures"
...
if (!(canadian & file.exists(plotListName))){
  ...
  ggsave(gsub("png","eps",canadianFigName),
         canadian_fig2,
         device = "eps",
         width = 175,
         height = 237,
